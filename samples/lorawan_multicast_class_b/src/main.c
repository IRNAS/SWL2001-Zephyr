/** @file main.c
 *
 * @brief LoRaWAN multicast class b example
 *
 * @par
 ...
 */
#define MULTICAST_GROUP_ADDRESS (0x87e1464d)
 ...
 */
#define MULTICAST_SESSION_PING_SLOT SMTC_MODEM_CLASS_B_PINGSLOT_32_S

/**
 * @brief Multicast network session key
 */
#define MULTICAST_NWK_SESSION_KEY                                                                  \
 ...
 */
#define MULTICAST_APP_SESSION_KEY                                                                  \
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                                           \
	 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
void on_modem_reset(uint16_t reset_count)
{
	...
	smtc_modem_return_code_t ret = smtc_modem_multicast_set_grp_config(
		STACK_ID, MULTICAST_GROUP, MULTICAST_GROUP_ADDRESS, mc_nwk_skey, mc_app_skey);
